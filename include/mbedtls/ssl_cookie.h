 ...
 */
IMPORT_C void mbedtls_ssl_cookie_init(mbedtls_ssl_cookie_ctx *ctx);

/**
 * \brief          Setup cookie context (generate keys)
 */
IMPORT_C int mbedtls_ssl_cookie_setup(mbedtls_ssl_cookie_ctx *ctx,
 ...
 */
IMPORT_C void mbedtls_ssl_cookie_set_timeout(mbedtls_ssl_cookie_ctx *ctx, unsigned long delay);

/**
 * \brief          Free cookie context
 */
IMPORT_C void mbedtls_ssl_cookie_free(mbedtls_ssl_cookie_ctx *ctx);
