 ...
 */
IMPORT_C const mbedtls_pk_info_t *mbedtls_pk_info_from_type(mbedtls_pk_type_t pk_type);
 ...
 */
IMPORT_C void mbedtls_pk_init(mbedtls_pk_context *ctx);
 ...
 */
IMPORT_C void mbedtls_pk_free(mbedtls_pk_context *ctx);
 ...
 */
IMPORT_C int mbedtls_pk_setup(mbedtls_pk_context *ctx, const mbedtls_pk_info_t *info);
 ...
 */
IMPORT_C int mbedtls_pk_setup_opaque(mbedtls_pk_context *ctx,
 ...
 */
IMPORT_C int mbedtls_pk_setup_rsa_alt(mbedtls_pk_context *ctx, void *key,
 ...
 */
IMPORT_C size_t mbedtls_pk_get_bitlen(const mbedtls_pk_context *ctx);
 ...
 */
IMPORT_C int mbedtls_pk_can_do(const mbedtls_pk_context *ctx, mbedtls_pk_type_t type);
 ...
 */
IMPORT_C int mbedtls_pk_can_do_ext(const mbedtls_pk_context *ctx, psa_algorithm_t alg,
 ...
 */
IMPORT_C int mbedtls_pk_verify(mbedtls_pk_context *ctx, mbedtls_md_type_t md_alg,
 ...
 */
IMPORT_C int mbedtls_pk_verify_restartable(mbedtls_pk_context *ctx,
 ...
 */
IMPORT_C int mbedtls_pk_verify_ext(mbedtls_pk_type_t type, const void *options,
 ...
 */
IMPORT_C int mbedtls_pk_sign(mbedtls_pk_context *ctx, mbedtls_md_type_t md_alg,
                    const unsigned char *hash, size_t hash_len,
 ...
 *
 */
IMPORT_C int mbedtls_pk_sign_ext(mbedtls_pk_type_t pk_type,
 ...
 *                  operations was reached: see \c mbedtls_ecp_set_max_ops().
 */
IMPORT_C int mbedtls_pk_sign_restartable(mbedtls_pk_context *ctx,
                                mbedtls_md_type_t md_alg,
                                const unsigned char *hash, size_t hash_len,
                                unsigned char *sig, size_t sig_size, size_t *sig_len,
                                int (*f_rng)(void *, unsigned char *, size_t), void *p_rng,
 ...
 * \return          0 on success, or a specific error code.
 */
IMPORT_C int mbedtls_pk_decrypt(mbedtls_pk_context *ctx,
 ...
 * \return          0 on success, or a specific error code.
 */
IMPORT_C int mbedtls_pk_encrypt(mbedtls_pk_context *ctx,
                       const unsigned char *input, size_t ilen,
                       unsigned char *output, size_t *olen, size_t osize,
                       int (*f_rng)(void *, unsigned char *, size_t), void *p_rng);
 ...
 */
IMPORT_C int mbedtls_pk_check_pair(const mbedtls_pk_context *pub,
 ...
 */
IMPORT_C int mbedtls_pk_debug(const mbedtls_pk_context *ctx, mbedtls_pk_debug_item *items);
 ...
 */
IMPORT_C const char *mbedtls_pk_get_name(const mbedtls_pk_context *ctx);
 ...
 */
IMPORT_C mbedtls_pk_type_t mbedtls_pk_get_type(const mbedtls_pk_context *ctx);
 ...
 */
IMPORT_C int mbedtls_pk_parse_key(mbedtls_pk_context *ctx,
 ...
 * \return          0 if successful, or a specific PK or PEM error code
 */
IMPORT_C int mbedtls_pk_parse_public_key(mbedtls_pk_context *ctx,
                                const unsigned char *key, size_t keylen);
 ...
 *                  error code
 */
IMPORT_C int mbedtls_pk_write_key_der(const mbedtls_pk_context *ctx, unsigned char *buf, size_t size);
 ...
 *                  error code
 */
IMPORT_C int mbedtls_pk_write_pubkey_der(const mbedtls_pk_context *ctx, unsigned char *buf, size_t size);
 ...
 */
IMPORT_C int mbedtls_pk_write_pubkey_pem(const mbedtls_pk_context *ctx, unsigned char *buf, size_t size);
 ...
 * \return          0 if successful, or a specific error code
 */
IMPORT_C int mbedtls_pk_write_key_pem(const mbedtls_pk_context *ctx, unsigned char *buf, size_t size);
 ...
 */
IMPORT_C int mbedtls_pk_parse_subpubkey(unsigned char **p, const unsigned char *end,
 ...
 */
IMPORT_C int mbedtls_pk_write_pubkey(unsigned char **p, unsigned char *start,
