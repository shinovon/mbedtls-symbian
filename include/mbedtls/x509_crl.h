 ...
 */
IMPORT_C int mbedtls_x509_crl_parse_der(mbedtls_x509_crl *chain,
 ...
 * \return         0 if successful, or a specific X509 or PEM error code
 */
IMPORT_C int mbedtls_x509_crl_parse(mbedtls_x509_crl *chain, const unsigned char *buf, size_t buflen);
 ...
 */
IMPORT_C int mbedtls_x509_crl_info(char *buf, size_t size, const char *prefix,
 ...
 */
IMPORT_C void mbedtls_x509_crl_init(mbedtls_x509_crl *crl);
 ...
 */
IMPORT_C void mbedtls_x509_crl_free(mbedtls_x509_crl *crl);
