...
/* Internal use */
IMPORT_C unsigned long mbedtls_timing_get_timer(struct mbedtls_timing_hr_time *val, int reset);
 ...
 */
IMPORT_C void mbedtls_timing_set_delay(void *data, uint32_t int_ms, uint32_t fin_ms);
 ...
 */
IMPORT_C int mbedtls_timing_get_delay(void *data);
 ...
 */
IMPORT_C uint32_t mbedtls_timing_get_final_delay(
