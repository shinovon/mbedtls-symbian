 ...
 */
IMPORT_C void mbedtls_hmac_drbg_init(mbedtls_hmac_drbg_context *ctx);
 ...
 */
IMPORT_C int mbedtls_hmac_drbg_seed(mbedtls_hmac_drbg_context *ctx,
 ...
 *                      memory to allocate context data.
 */
IMPORT_C int mbedtls_hmac_drbg_seed_buf(mbedtls_hmac_drbg_context *ctx,
                               const mbedtls_md_info_t *md_info,
 ...
 */
IMPORT_C void mbedtls_hmac_drbg_set_prediction_resistance(mbedtls_hmac_drbg_context *ctx,
                                                 int resistance);
 ...
 */
IMPORT_C void mbedtls_hmac_drbg_set_entropy_len(mbedtls_hmac_drbg_context *ctx,
                                       size_t len);
 ...
 */
IMPORT_C void mbedtls_hmac_drbg_set_reseed_interval(mbedtls_hmac_drbg_context *ctx,
                                           int interval);
 ...
 *                      hash calculation.
 */
IMPORT_C int mbedtls_hmac_drbg_update(mbedtls_hmac_drbg_context *ctx,
 ...
 */
IMPORT_C int mbedtls_hmac_drbg_reseed(mbedtls_hmac_drbg_context *ctx,
 ...
 */
IMPORT_C int mbedtls_hmac_drbg_random_with_add(void *p_rng,
 ...
 */
IMPORT_C int mbedtls_hmac_drbg_random(void *p_rng, unsigned char *output, size_t out_len);
 ...
 */
IMPORT_C void mbedtls_hmac_drbg_free(mbedtls_hmac_drbg_context *ctx);
 ...
 *                      failure.
 */
IMPORT_C int mbedtls_hmac_drbg_write_seed_file(mbedtls_hmac_drbg_context *ctx, const char *path);
 ...
 */
IMPORT_C int mbedtls_hmac_drbg_update_seed_file(mbedtls_hmac_drbg_context *ctx, const char *path);
#endif /* MBEDTLS_FS_IO */
