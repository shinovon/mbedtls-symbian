 ...
 *
 */
IMPORT_C void mbedtls_nist_kw_init(mbedtls_nist_kw_context *ctx);
 ...
 */
IMPORT_C int mbedtls_nist_kw_setkey(mbedtls_nist_kw_context *ctx,
 ...
 */
IMPORT_C void mbedtls_nist_kw_free(mbedtls_nist_kw_context *ctx);
 ...
 * \return          cipher-specific error code on failure of the underlying cipher.
 */
IMPORT_C int mbedtls_nist_kw_wrap(mbedtls_nist_kw_context *ctx, mbedtls_nist_kw_mode_t mode,
 ...
 * \return          cipher-specific error code on failure of the underlying cipher.
 */
IMPORT_C int mbedtls_nist_kw_unwrap(mbedtls_nist_kw_context *ctx, mbedtls_nist_kw_mode_t mode,
                           const unsigned char *input, size_t in_len,
                           unsigned char *output, size_t *out_len, size_t out_size);
