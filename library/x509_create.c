...
EXPORT_C int mbedtls_x509_string_to_names(mbedtls_asn1_named_data **head, const char *name)
{
    int ret = 0;
 ...
 */
EXPORT_C int mbedtls_x509_set_extension(mbedtls_asn1_named_data **head, const char *oid, size_t oid_len,
...
EXPORT_C int mbedtls_x509_write_names(unsigned char **p, unsigned char *start,
...
EXPORT_C int mbedtls_x509_write_sig(unsigned char **p, unsigned char *start,
 ...
 *     }
 */
EXPORT_C int mbedtls_x509_write_extensions(unsigned char **p, unsigned char *start,
                                  mbedtls_asn1_named_data *first)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    size_t len = 0;
